...
// 
namespace IB.Core.SqlQueryBuilder
{
    public class SelectQueryBuilder : IQueryBuilder
    {
        ...
        public WhereClause AddWhere(System.Enum field, Comparison @operator, object compareValue) { return AddWhere(field.ToString(), @operator, compareValue, 1); }
        ...
        public void AddOrderBy(System.Enum field, Sorting order) { this.AddOrderBy(field.ToString(), order); }
        ...
        public WhereClause AddHaving(System.Enum field, Comparison @operator, object compareValue) { return AddHaving(field.ToString(), @operator, compareValue, 1); }
